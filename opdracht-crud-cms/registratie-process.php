<?php
	...
	if (isset($_POST['generatePassword']))
	{
		...
		header("Location: http://oplossingen.web-backend.local/opdracht-crud-cms/registratie-form.php");
	}
	...
	if (isset($_POST['submit'])) 
	{
		...
		else
		{
			...
			else
			{
				...
				header("Location: http://oplossingen.web-backend.local/opdracht-crud-cms/dashboard.php");
			}
		}
	}
