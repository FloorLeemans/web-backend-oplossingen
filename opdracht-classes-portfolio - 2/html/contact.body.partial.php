        ...
        <section class="portfolio-body group">
            <section class="portfolio-content">
                <article>
                    <div class="head">
                        <img src="http://oplossingen.web-backend.local/opdracht-classes-portfolio/img/strandbeest-theo-jansen.jpg" alt="Strandbeest Theo Jansen">
            ...
            <section class="portfolio-aside">         
                <section class="profile">
                    <img src="http://oplossingen.web-backend.local/opdracht-classes-portfolio/img/floor_leemans.jpg" alt="Floor Leemans">
                    <h1>Floor Leemans</h1>
                </section>
