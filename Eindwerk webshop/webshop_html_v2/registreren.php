...
<html lang="nl" class="gradient">
	<head>
		...
		<title>Registreren - Movie shot</title>
	...
	<!-- HEADER -->
		...
		<header class="container">
			<div class="row top">
				...
				<div class="col-md-6 col-sm-6">
					<nav class="login">
						<p><a href="inloggen.php">Inloggen</a><a href="registreren.php" class="active">Registreren</a><a href="winkelmandje.php"><img src="img/winkelkar.png" alt="winkelmandje"></a></p>
					</nav>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-8 col-sm-8">
						...
						<form>
							...
							<div class="row">
								<div class="col-md-2 col-sm-2">
									<p><strong>E-mailadres herhalen</strong></p>
								</div>
								<div class="col-md-10 col-sm-10">
									<input type="text" value="">
								</div>
							...
							<div class="row">
								<div class="col-md-2 col-sm-2">
									<p><strong>Wachtwoord herhalen</strong></p>
								</div>
								<div class="col-md-10 col-sm-10">
									<input type="text" value="">
								</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<a href="profiel.php">
									<button style="float:right">Registreren</button>
								</a>
							</div>
						</div>
					</div>
